...
const recs = [
  {
    ...
    tags: ["park", "seawall", "views", "nature"], duration: "2–5 hrs", img: "images/stanleypark.jpg"
  },
  {
...
function render() {
  ...
  for (const rec of filteredRecs) {
    ...
    if (rec.duration && card.querySelector(".t-duration")) {
      card.querySelector(".t-duration").textContent = `⏱ ${rec.duration}`;
    }
